...
// === ARCHIVO: src/app/standalone-components/loan-info.component.ts ===
...
// === ARCHIVO: src/app/signals/user-events.signal.ts ===
import { signal } from '@angular/core';

export const userEvents = signal({});

// === ARCHIVO: src/app/state-management/loan-state.service.ts ===
...
// === ARCHIVO: angular.json ===
{
    ...
    "standalone-components-example": {
      ...
      "architect": {
        "build": {
          ...
          "options": {
            "outputPath": "dist/standalone-components-example",
        ...
        "serve": {
          ...
          "configurations": {
            "production": {
              "browserTarget": "standalone-components-example:build:production"
            }
          }
        },
        "extract-i18n": {
          ...
          "options": {
            "browserTarget": "standalone-components-example:build"
          }
        },
        "test": {
  ...
  "defaultProject": "standalone-components-example"
}
...
{
  "name": "standalone-components-example",
  "version": "0.0.0",
  "scripts": {
    "ng": "ng",
    "start": "ng serve",
